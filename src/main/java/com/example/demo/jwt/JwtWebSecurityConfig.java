...
public class JwtWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity webSecurity) throws Exception {
        webSecurity
                ...
                .antMatchers(HttpMethod.GET, "/diagnostics/**")
                .antMatchers(HttpMethod.GET, "/discounts/**")
                .antMatchers(HttpMethod.GET, "/normals/**")
                .antMatchers(HttpMethod.GET, "/patients/**")
                .antMatchers(HttpMethod.GET, "/physicians/**")
                .antMatchers(HttpMethod.GET, "/representatives/**")
                .antMatchers(HttpMethod.GET, "/tubes/**")
